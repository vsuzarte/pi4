            ...
            <div class="row">
                ...
                <div class="col-md-12 order-md-1 pt-2 pb-4">
                    ...
                    <form action="${pageContext.request.contextPath}/cadastro-produto" method="post">
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="desc1">Marca*</label>
                                <input type="text" class="form-control" id="desc1" name = "c1" placeholder="Marca" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="desc2">Modelo*</label>
                                <input type="text" class="form-control" id="desc2" name = "c2" placeholder="Modelo" required>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="nome">TipoTeclado/FormatoFone/ResoluçãoSensor/Material</label>
                                <input type="text" class="form-control" id="desc3" name = "c3" placeholder="..." required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="desc4">Layout/Resposta/Botões/Largura</label>
                                <input type="text" class="form-control" id="desc4" name = "c4" placeholder="..." required>
                            </div>
                        </div>

                        <div class="row">
                            <div class="col-md-6 mb-3">
                                <label for="desc5">Compatibilidade/Conector/Sensor/Comprimento</label>
                                <input type="text" class="form-control" id="desc5" name = "c5" placeholder="Desc5" required>
                            </div>
                            <div class="col-md-6 mb-3">
                                <label for="desc6">Conexão/Espessura</label>
